...
public class BitmapDisplayConfig {
	...
	public int getTansitionDuration() {
		return tansitionDuration;
	}

	public void setTansitionDuration(int tansitionDuration) {
		this.tansitionDuration = tansitionDuration;
	}
