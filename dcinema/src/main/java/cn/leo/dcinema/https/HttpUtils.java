...
public class HttpUtils {
    ...
    public static byte[] getBinary(String url, Header aheader[],
                                   NameValuePair anamevaluepair[]) {
        byte result[] = null;
        HttpResult httpresult = HttpClientHelper.get(url, aheader,
    ...
    public static String getContent(String url, Header aheader[],
                                    NameValuePair nameValuePairs[]) {
        String s1 = null;
        HttpResult httpresult = HttpClientHelper.get(url, aheader, nameValuePairs);
